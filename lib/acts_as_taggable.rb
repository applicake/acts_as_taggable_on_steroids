load File.join(File.dirname(__FILE__), 'tag_list.rb')
load File.join(File.dirname(__FILE__), 'tagging.rb')
load File.join(File.dirname(__FILE__), 'tag.rb')
load File.join(File.dirname(__FILE__), 'tags_helper.rb')
